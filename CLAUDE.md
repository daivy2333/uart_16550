...
> Project: uart_16550
> Type: Rust no_std embedded library (v0.6.0)
...
uart_16550 是一个 Rust `no_std` 嵌入式库，提供 16550 UART 设备的低级驱动，支持 x86 Port I/O 和 MMIO 两种后端（编译期泛型分发）。属于 rust-osdev 社区项目，当前版本 v0.6.0，本仓库为 StarryOS 高性能异步串口提供底层驱动模块。
